...
export const alt = "Nara app preview";
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const appName = "Nara";
const description = "Nara is a warm, emotionally intelligent parenting companion for parents and caregivers of children facing any challenge — autism, ADHD, anxiety, sens...";
const icon = "🎯";
